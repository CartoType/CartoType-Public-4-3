...
class MTileNameProvider
    ...
    */
    virtual const MString* TileName(TResult& aError,int32 aZoom,int32 aX,int32 aY);
    ...
    */
    virtual int32 GetTileZoomLevel(double aScaleDenominator);
    };
...
class TTileParam
    ...
    TTileParam(const CString& aTileNameFormat,const CString& aZoomLevels,
               ...
               int32 aProjectionEpsg = KEpsgWebMercator):
    ...
    TResult SetExtent(int32 aZoomLevel,int32 aLeft,int32 aTop,int32 aRight,int32 aBottom);
    ...
    */
    ...
    /** The optional extent, in map coordinates, of the map (default = NULL); if empty, a whole-world extent is used. */
    TRect iExtent;
